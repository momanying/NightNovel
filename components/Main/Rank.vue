<template>
    <div class="popular-ranking">
      ...
      <div class="flex justify-center items-end overflow-hidden border-b border-dashed border-gray-600 mb-4">
          <!-- 第二名 -->
          <div class="flex flex-col items-center relative w-1/3 cursor-pointer" @click="openNovelDetail(topNovels[1]._id || 0)">
          ...
          <!-- 第一名 -->
          <div class="flex flex-col items-center relative w-1/3 cursor-pointer" @click="openNovelDetail(topNovels[0]._id || 0)">
              <div class="w-[90px] h-[115px] relative mb-2.5 rounded-lg overflow-hidden shadow-md transition-transform duration-300 hover:-translate-y-1">
                  <img
                    class="w-full h-full object-cover" 
          ...
          <!-- 第三名 -->
          <div class="flex flex-col items-center relative w-1/3 cursor-pointer" @click="openNovelDetail(topNovels[2]._id || 0)">
              <div class="w-[90px] h-[115px] relative mb-2.5 rounded-lg overflow-hidden shadow-md transition-transform duration-300 hover:-translate-y-1">
                  <img
                    class="w-full h-full object-cover" 
      ...
      <div class="px-4">
          <ul>
              <li 
                ...
                @click="openNovelDetail(novel._id || 0)"
              >
                {{ index + 4 }}、{{ novel.title }}
              </li>
          </ul>
