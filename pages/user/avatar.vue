        ...
        <div class="flex-1 flex flex-col items-center md:items-start space-y-4">
          ...
          <div v-if="selectedAvatarFile">
            ...
            <button
              type="button"
              :disabled="isUploading"
              class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-green-500 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 focus:ring-offset-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"
              @click="uploadAvatar"
            >
